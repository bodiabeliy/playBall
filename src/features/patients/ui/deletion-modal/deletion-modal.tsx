import { Dialog, DialogContent, Button, Box, Typography, useMediaQuery, useTheme } from '@mui/material'
  ...
  return (
    <Dialog open={open} onClose={onClose} maxWidth="sm" fullWidth>
      <Box sx={{ display: 'flex', alignItems: 'center', p: 2, background: '#f4f7fe', justifyContent: 'space-between' }}>
        ...
        {selectedCount && !isMobile && <Typography variant="body1">Вибрано: {selectedCount}</Typography>}
      </Box>
